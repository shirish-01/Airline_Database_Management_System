...
CREATE TABLE `seat` (
  ...
  CONSTRAINT `seat_ibfk_1` FOREIGN KEY (`CustId`) REFERENCES `customer` (`CustId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `seat_ibfk_2` FOREIGN KEY (`TicketNo`) REFERENCES `ticket` (`TicketNo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `seat_ibfk_3` FOREIGN KEY (`AirplaneId`) REFERENCES `aeroplane` (`AirplaneId`) ON DELETE CASCADE ON UPDATE CASCADE
